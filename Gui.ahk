...
BuildGui() {
    ...
    tabLabels := T("tabHome") "|" T("tabGeneral") "|" T("tabGuild") "|" T("tabWar") "|" T("tabScreen")
	...
	Gui, Add, Text, x35 y425 w280, % T("wip") ; DELETE THIS STRING, when complite
	...
	Gui, Add, Text, x350 y90 w250, % T("wip") ; DELETE THIS STRING, when complite
	...
	; ========== WORK IN PROGRESS ==========
    Gui, Add, Checkbox, x665 y250 w250 vToken Checked%Token%, % T("(DOES NOT WORK) tavernToken")	;T("tavernToken")
    Gui, Add, Checkbox, x665 y275 w250 vBeer Checked%Beer%, % T("(dont turn off) skipBeer")			;T("skipBeer")
    Gui, Add, Checkbox, x665 y300 w250 vScarab Checked%Scarab%, % T("(dont turn off) skipScarab")	;T("skipScarab")
    ; ============ UNTILL HERE =============
...
T(key) {
    ...
    if !IsObject(strings) {
        strings := {}
		strings["wip"] := {ru: "!не работает!", en: "!dsnt work! Work in progress"}
        strings["tabHome"] := {ru: "Главная", en: "Home"}
        strings["tabGeneral"] := {ru: "Общие настройки", en: "General Options"}
        strings["tabGuild"] := {ru: "Гильдия и личное древо", en: "Guild and Personal Tree"}
        ...
        strings["sellEx"] := {ru: "(Master) Открывать торговца", en: "(Master) Open Exotic Merchant"}
        ...
        strings["skipOracle"] := {ru: "(общее) пропустить оракула", en: "(Master) Skip Oracle"}
        ...
        strings["openChests"] := {ru: "Открывать сундуки (общее)", en: "(Master) Open Chests"}
        ...
        strings["skipHeroes"] := {ru: "(общее) не улучшать героев", en: "(Master) Do Not Upgrade Heroes"}
        ...
        strings["skipGuild"] := {ru: "(общее) пропустить активности гильдии", en: "(Master) Skip Guild Activities"}
